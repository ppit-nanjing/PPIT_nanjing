      ...
      {cities.map((city) => {
        ...
        return (
          <motion.button
            ...
            whileHover={{ y: -4 }}
            className="bg-surface-container-low border border-outline-variant rounded-lg p-5 flex flex-col gap-3 hover:border-primary-container hover:shadow-[0_10px_30px_rgba(39,23,22,0.05)] transition-[box-shadow,border-color] motion-reduce:transition-none text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-container focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
